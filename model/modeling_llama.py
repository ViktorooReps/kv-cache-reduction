...
ALL_ATTENTION_FUNCTIONS["flex_attention_with_kv_bias"] = flex_attention_with_kv_bias


class AttentionKwargs(FlashAttentionKwargs, FlexAttentionKwargs): ...
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def _update_causal_mask(
        ...
        if self.config._attn_implementation == "flex_attention_with_kv_bias":
            # FIXME: this discards attention mask
            return create_block_mask(
                lambda b, h, q_idx, kv_idx: q_idx + past_seen_tokens >= kv_idx,
                B=None,
                H=None,
                Q_LEN=seq_length,
                KV_LEN=seq_length + past_seen_tokens,
...
class KwargsForCausalLM(AttentionKwargs, LossKwargs): ...
